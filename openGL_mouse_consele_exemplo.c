...
char texto[30];
GLfloat win, r, g, b;
GLint view_w, view_h, primitiva;// Desenha um texto na janela GLUT
...
while(*string)
glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN
_10,*string++);
glPopMatrix();
}
...
// Função callback chamada quando o tamanho da janela é
alterado
...
// Função callback chamada para gerenciar eventos do
mouse
...
// Função callback chamada sempre que o mouse é
movimentado
